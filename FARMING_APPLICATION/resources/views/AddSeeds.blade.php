                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="#">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Select Your Seeds Image</label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">seeds Name</label>
                                        <div class="col-lg-9">
                                        <input type="text" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">available Seeds Kg:</label>
                                        <div class="col-lg-9">
                                        <input type="text" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">seeds Price</label>
                                        <div class="col-lg-9">
                                        <input type="text" class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Information about Seeds</label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="text-right">
                                        <button type="submit" class="btn btn-primary">Submit Details <i class="icon-paperplane ml-2"></i></button>
                                    </div>
                                </form>
                            </div>
                        </div>
