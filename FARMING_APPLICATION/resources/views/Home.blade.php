                            ...
                            <ul class="media-list">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="media-title">
                                            <a href="#">
                                                <span class="font-weight-semibold">Vinthusha</span>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="media-title">
                                            <a href="#">
                                                <span class="font-weight-semibold">Pethurushan</span>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="media-title">
                                            <a href="#">
                                                <span class="font-weight-semibold">Mathunujan</span>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="media-title">
                                            <a href="#">
                                                <span class="font-weight-semibold">Logitha</span>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="media-title">
                                            <a href="#">
                                                <span class="font-weight-semibold">Thanojika</span>
                        ...
                        <a href="#" class="dropdown-item"><i class="icon-switch2"></i> Logout</a><div class="navbar navbar-expand-md navbar-dark">
                            ...
                            <div class="collapse navbar-collapse" id="navbar-mobile">
                                ...
                                <ul class="navbar-nav">
                                                ...
                                                <ul class="media-list">
                                                    <li class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <div class="media-title">
                                                                <a href="#">
                                                                    <span class="font-weight-semibold">Vnthusha</span>
                                                                    <span class="text-muted float-right font-size-sm">04:58</span>
                                                                </a>
                                                            </div>
                                                    ...
                                                    <li class="media">
                                                        <div class="mr-3">
                                                            <img src="memimg/sanjsi.jpg" width="36" height="36" class="rounded-circle" alt="">
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="media-title">
                                                                <a href="#">
                                    ...
                                    <li class="nav-item dropdown dropdown-user">
                                        <a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
                                            <img src="memimg/sanjsi.jpg" class="rounded-circle mr-2" height="34" alt="">
                                            <span>Victoria</span>
                                        </a>
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-user">
                    <div class="card-body">
                        <div class="media">
                            <div class="mr-3">
                                <a href="#"><img src="memimg/sanjsi.jpg" width="38" height="38" class="rounded-circle" alt=""></a>
                            </div>

                            <div class="media-body">
                                <div class="media-title font-weight-semibold">Sanjsigan</div>
                                <div class="font-size-xs opacity-50">
                                    <i class="icon-pin font-size-sm"></i> &nbsp;Admin Of SJ
                                </div>
                            </div>
            ...
            <div class="row">
                    <div class="col-xl-7">
                       ...
                       <div class="card bg-teal-400">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <h3 class="font-weight-semibold mb-0">39</h3>
                                           
                                        </div>

                                        <div>
                                           Suggestion  of New Members 
                                            <div class="font-size-sm opacity-75">30 New Members Suggestio for You</div>
                                        </div>
                                    </div>
                       ...
                       <div class="card bg-teal-400">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <h3 class="font-weight-semibold mb-0">3 category Products</h3>
                                            
                                        </div>

                                        <div>
                                         Details of new Products Details
                                            <div class="font-size-sm opacity-75">50 New Products Added.. </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-8">
                        ...
                        <div class="card">
                            <div class="card-header header-elements-sm-inline">
                                <h6 class="card-title">New Orders Details..</h6>
                                <div class="header-elements">
                                    <span class="badge bg-success badge-pill">28 orders</span>
                            ...
                            <div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
                                <div class="d-flex align-items-center mb-3 mb-sm-0">
                                    ...
                                    <div class="ml-3">
                                        <h5 class="font-weight-semibold mb-0">12 Order<span class="text-success font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i></span></h5>
                                ...
                                <div class="d-flex align-items-center mb-3 mb-sm-0">
                                    ...
                                    <div class="ml-3">
                                        <h5 class="font-weight-semibold mb-0">32 ordes <span class="text-danger font-size-sm font-weight-normal"><i class="icon-arrow-down12"></i></span></h5>
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name of prodect</th>
                                            <th>How many Order</th>
                                            <th>Budget</th>
                                            <th>Status</th>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold">Seeds Products</a>
                                                      
                                                    </div>
                                                </div>
                                            </td>
                                            <td><span class="text-muted">Flaxseeds</span></td>
                                            <td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i>27 Order</span></td>
                                            <td>
                                                <h6 class="font-weight-semibold mb-0">RS.30,000/=</h6>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold">Paddy Products</a>
                                                       
                                                    </div>
                                                </div>
                                            </td>
                                            <td><span class="text-muted">Palakkad Matta Rice</span></td>
                                            <td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i> 21 order</span></td>
                                            <td>
                                                <h6 class="font-weight-semibold mb-0">RS 45.000/=</h6>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold">Fruit Products</a>
                                                      
                                                    </div>
                                                </div>
                                            </td>
                                            <td><span class="text-muted">Mangoes</span></td>
                                            <td><span class="text-danger"><i class="icon-stats-decline2 mr-2"></i>98 Order</span></td>
                                            <td>
                                                <h6 class="font-weight-semibold mb-0">RS 34,000/=</h6>
                                            </td>
                                            <td><span class="badge bg-grey-400">Active</span></td>
                                            <td class="text-center">
                                                <div class="list-icons">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold">Vegatable Products</a>
                                                      
                                                    </div>
                                                </div>
                                            </td>
                                            <td><span class="text-muted">Pumpkin Flake</span></td>
                                            <td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i> 43 order</span></td>
                                            <td>
                                                <h6 class="font-weight-semibold mb-0">54,000/=</h6>
                                            </td>
                                            <td><span class="badge bg-grey-400">empty</span></td>
                                            <td class="text-center">
                                                <div class="list-icons">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold">Tuber Products</a>
                                                        
                                                    </div>
                                                </div>
                                            </td>
                                            <td><span class="text-muted">Potatoes</span></td>
                                            <td><span class="text-danger"><i class="icon-stats-decline2 mr-2"></i>32 order</span></td>
                                            <td>
                                                <h6 class="font-weight-semibold mb-0">RS 23,000/=</h6>
                                            </td>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title">Daily sales Status</h6>
                                <div class="header-elements">
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            <th class="w-100">Product Type</th>
                                            <th>Time</th>
                                            <th>Price</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Seeds Products</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Vegetable Products</a>
                                            ...
                                            <td>
                                                <h6 class="font-weight-semibold mb-0">RS 12.000/=</h6>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Fruit Products</a>
                                                        <div class="text-muted font-size-sm"><i class="icon-lifebuoy font-size-sm mr-1"></i> New Order</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <h6 class="font-weight-semibold mb-0">RS 13.000/=</h6>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Paddy Products</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="text-default font-weight-semibold letter-icon-title">Tuber Products</a>
                                            ...
                                            <td>
                                                <h6 class="font-weight-semibold mb-0">RS 10.000/=</h6>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
