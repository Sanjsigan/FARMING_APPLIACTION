                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="#">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Select Your Tuber Image</label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Tuber Name</label>
                                        <div class="col-lg-9">
                                        <input type="text" class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Information about Tuber</label>
                                        <div class="col-lg-9">
